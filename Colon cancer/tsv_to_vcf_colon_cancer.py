...
def reorganize(num_samples,max_files,main_folder):
    ...
    for i in range(num_folders):
        folder_name = "set"+str(i+1)+"_simulated_colon_cancer_panel"
...
def main():
    ...
    tsv_2_vcf(filename='colon_cancer_data.tsv', startfile='startText.txt', num_samples=num_samples)
    #Reorganize the files into the correct format
    #reorganize(num_samples=num_samples, max_files=max_files, main_folder = "colon_cancer_vcfs")
